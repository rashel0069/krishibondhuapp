...
import com.example.krishibondhuapp.Activity.AudioPost;
import com.example.krishibondhuapp.Adaptar.PostAdapter;
    ...
    private void displayPost() {
        ...
        firebaseDatabase.getInstance().getReference().child("Post").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                postAdapter = new PostAdapter(listItem,getContext());
